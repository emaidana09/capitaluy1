      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="flex flex-col md:flex-row md:justify-center md:items-start gap-8 lg:gap-12 text-left">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed text-pretty text-left max-w-xs mx-0 pl-0">
          ...
          >
            <h3 className="font-semibold text-foreground mb-4 text-left md:text-left">Menu</h3>
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-gray-700 dark:text-gray-500 cursor-not-allowed flex items-center justify-start gap-2">
                  Cursos
          ...
          >
            <h3 className="font-semibold text-foreground mb-4 text-left md:text-left">Contacto</h3>
            <ul className="space-y-3">
              <li className="flex items-center justify-start md:justify-start gap-2 text-muted-foreground min-w-0">
              ...
              <li className="flex items-center justify-start md:justify-start gap-2 text-muted-foreground">
          ...
          >
            <h3 className="font-semibold text-foreground mb-4 text-left md:text-left">Seguinos</h3>
            <div className="flex gap-6 items-center justify-start md:justify-start">
              <a
